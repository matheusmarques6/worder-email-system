        ...
        <div className="max-w-md space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="flex h-10 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm focus:border-[#F26B2A] focus:outline-none focus:ring-1 focus:ring-[#F26B2A]"
            >
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <button
            ...
            disabled={loading}
            className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-white p-8 transition-colors hover:border-[#F26B2A] hover:bg-orange-50"
          >
            <Plus size={32} className="mb-2 text-gray-400" />
            <span className="text-sm font-medium text-gray-700">
              Começar do Zero
            </span>
            <span className="text-xs text-gray-400">Template em branco</span>
          </button>
          ...
          {prebuiltTemplates.map((pt) => (
            <button
              ...
              disabled={loading}
              className="flex flex-col items-center justify-center rounded-lg border border-gray-200 bg-white p-8 shadow-sm transition-colors hover:border-[#F26B2A] hover:bg-orange-50"
            >
